...
char ssid[] = "Welcome To K.S.T.P";
const char* pass = "";

const String prefix   = "/IoTmanager";      // global prefix for all topics - must be some as mobile device
const char* deviceId = "AC2";    // thing Id - unique device id in our project
...
void initVar() {
  id    [0] = "0";
  page  [0] = "AC2";
  pageId[0] = 2;                                           // pageId always start with 1
  descr [0] = "Angle";
  widget[0] = "anydata";
  defaultVal[0] = 0;
  inverted[0] = false;
